          ...
          <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200/80 shadow-xs flex flex-col sm:flex-row items-center gap-4">
            ...
            >
              <img
                ...
                className="w-20 h-20 rounded-full object-cover border-3 border-[#003366] shadow-md bg-white group-hover:opacity-85 transition-opacity"
                onError={(e) => {
              ...
              <span className="absolute -bottom-1 -right-1 text-[9px] font-extrabold bg-[#003366] text-[#98FF98] px-2 py-0.5 rounded-full border border-white shadow-xs z-10">
                GVCN
              </span>
            </div>
